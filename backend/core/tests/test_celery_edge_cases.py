...
class TestCeleryEdgeCases:
    ...
    def test_task_failure_without_sender(self, mock_logger):
        ...
        task_failure_handler(sender=None, task_id="fail-id", exception=exception, einfo=None)
    ...
    def test_task_failure_with_no_exception(self, mock_logger):
        ...
        task_failure_handler(sender=mock_task, task_id="fail-id", exception=None, einfo=None)
...
class TestFilterSensitiveKwargsEdgeCases:
    ...
    def test_filters_list_values(self):
        ...
        kwargs = {"items": ["item1", "item2", "item3"]}
    ...
    def test_filters_boolean_values(self):
        ...
        kwargs = {"is_active": True, "is_deleted": False}
    ...
    def test_deeply_nested_structure(self):
        ...
        kwargs = {"level1": {"level2": {"level3": {"password": "secret"}}}}
