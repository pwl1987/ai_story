    ...
    def get(self, request):
        ...
        try:
            ...
            if not image_dir.exists():
                return Response(
                    {"success": False, "message": "图片目录不存在", "data": []},
            ...
            return Response(
                {"success": False, "message": f"获取图片列表失败: {e!s}", "data": []},
...
class StorageImageDetailView(APIView):
    ...
    def get(self, request, filepath):
        ...
        try:
            ...
            # 返回文件响应
            return FileResponse(
                open(image_path, "rb"), content_type=self._get_content_type(image_path.suffix)
            )
...
class StorageVideoDetailView(APIView):
    ...
    def get(self, request, filepath):
        ...
        try:
            ...
            # 返回文件响应
            return FileResponse(
                open(video_path, "rb"), content_type=self._get_content_type(video_path.suffix)
            )
