...
urlpatterns = [
    ...
    path(
        "storage/image/<path:filepath>",
        StorageImageDetailView.as_view(),
        name="storage-image-detail",
    ),
    # 支持日期子目录: storage/video/2025-11-30/xx.mp4
    path(
        "storage/video/<path:filepath>",
        StorageVideoDetailView.as_view(),
        name="storage-video-detail",
    ),
    # 内容生成API
    # 待实现
]
