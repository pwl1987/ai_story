...
class TestSimpleE2EWorkflow:
    ...
    def test_project_creates_all_stages(
        self,
        api_client,
        configured_user,
        template_set
    ...
    def test_stage_data_flow_structure(
        self,
        api_client,
        configured_user,
        template_set
    ...
    def test_full_workflow_data_integrity(
        self,
        api_client,
        configured_user,
        template_set
