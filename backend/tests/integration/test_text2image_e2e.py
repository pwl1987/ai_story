...
class TestText2ImageE2E:
    ...
    def configured_user(self, db):
        ...
        user = User.objects.create_user(
            username="text2image_test_user", email="text2image@test.com"
        )
        return user
    ...
    def template_set(self, db, configured_user):
        ...
        template_set = PromptTemplateSet.objects.create(
            name="Text2Image Template Set", is_default=True, created_by=configured_user
        )
        return template_set
    ...
    def test_e2e_text2image_after_storyboard(
        self, mock_execute_task, api_client, configured_user, model_provider, all_templates
    ):
        """
        ...
        # Mock AI客户端
        with patch(
            "apps.content.processors.text2image_stage.create_ai_client"
    ...
    def test_text2image_requires_storyboard_completion(
        self, api_client, configured_user, model_provider, all_templates
    ):
        """测试文生图需要storyboard完成"""
        # 1. 创建项目
        project_data = {
    ...
    def test_text2image_generates_multiple_images(
        ...
        with patch(
            ...
            def mock_generate(prompt, **kwargs):
                return {
                    "data": [{"url": "http://example.com/image.jpg", "width": 1920, "height": 1080}]
                }
        ...
        with patch(
            ...
            def mock_generate(prompt, **kwargs):
                ...
                return {
                    "data": [
                        {
                            "url": f"http://example.com/scene{call_count[0]}.jpg",
                            "width": 1920,
                            "height": 1080,
                        }
                    ]
