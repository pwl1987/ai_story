...
class TestImage2VideoE2E:
    ...
    def configured_user(self, db):
        ...
        user = User.objects.create_user(
            username='image2video_test_user',
            email='image2video@test.com'
        )
        return user
    ...
    def test_e2e_image2video_after_prerequisites(
        ...
        # Mock AI客户端
        with patch('apps.content.processors.image2video_stage.create_ai_client') as mock_create_client:
