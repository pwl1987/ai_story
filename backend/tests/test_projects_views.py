...
class TestProjectViewSet:
    ...
    def test_get_queryset_filters_by_user(self, api_client, test_user, project):
        ...
        Project.objects.create(name="其他项目", original_topic="其他主题", user=other_user)
    ...
    def test_create_action(self, api_client, test_user):
        ...
        data = {"name": "新项目", "description": "新项目描述", "original_topic": "新主题"}
    ...
    def test_permission_required(self):
        ...
        project = Project.objects.create(name="测试项目", original_topic="测试主题", user=user)
